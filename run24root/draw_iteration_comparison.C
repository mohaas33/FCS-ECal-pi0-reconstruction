...
void draw_iteration_comparison() {
  ...
  TH2F *h_correction_it2 = (TH2F*)readFileAndProcess("fcsgaincorr_222_3.txt","it2");
    ...
    TH2F* h_status_S_it1 = (TH2F*)get_histo("statusS_iteration2.root", "statusS");
    TH2F* h_status_N_it1 = (TH2F*)get_histo("statusN_iteration2.root", "statusN");
    TH2F* h_status_S_it2 = (TH2F*)get_histo("statusS_iteration3.root", "statusS");
    TH2F* h_status_N_it2 = (TH2F*)get_histo("statusN_iteration3.root", "statusN");
    ...
    h_status_axis->GetYaxis()->SetRangeUser(-35,0);
    h_status_axis->GetXaxis()->SetRangeUser(-23,23);
    h_status_axis->SetTitle("Status");
    // Draw the first histogram in the left pad
    canvas->cd(1);
    h_status_axis -> Draw("AXIS");
    ...
    TCanvas* canvas_corr = new TCanvas("canvas_corr", "2D Histograms", 1200, 900);
    gStyle->SetOptStat(0);
