...
void draw_all_towersmassfit2(const char* day="200", const char* iteration="2")
{
	...
	TFile* File1005=TFile::Open("/gpfs01/star/pwg/eshulga/Files/run24root/StFcsPi0invariantmass25200_2_tot.root");
